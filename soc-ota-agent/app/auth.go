...
import (
	...
	"github.com/binaryblack/OTA-Pulse/app/proxy"
	...
	"github.com/binaryblack/OTA-Pulse/device"
...
const (
	AuthManagerDBusPath                      = "/io/otapulse/AuthenticationManager"
	AuthManagerDBusObjectName                = "io.otapulse.AuthenticationManager"
	AuthManagerDBusInterfaceName             = "io.otapulse.Authentication1"
	AuthManagerDBusSignalJwtTokenStateChange = "JwtTokenStateChange"
	AuthManagerDBusInterface                 = `<node>
	<interface name="io.otapulse.Authentication1">
