...
const (
	...
	UpdateManagerDBusPath            = "/io/otapulse/UpdateManager"
	UpdateManagerDBusObjectName      = "io.otapulse.UpdateManager"
	UpdateManagerDBusInterfaceName   = "io.otapulse.Update1"
	UpdateManagerDBusInterface       = `
	    <node>
	      <interface name="io.otapulse.Update1">
