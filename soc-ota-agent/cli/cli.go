...
import (
	...
	mender_syslog "github.com/binaryblack/OTA-Pulse/log/syslog"
...
const (
	appDescription = "" +
		"OTAPulse - SoC Monitoring OTA Agent integrates both the daemon and commands " +
		...
		"  - OTAPULSE_CONF_DIR - configuration (default: /etc/otapulse, fallback: /etc/mender).\n" +
		"  - OTAPULSE_DATA_DIR - identity, inventory and update modules " +
		"(default: /usr/share/otapulse, fallback: /usr/share/mender).\n" +
		"  - OTAPULSE_DATASTORE_DIR - runtime datastore (default: /var/lib/otapulse, fallback: /var/lib/mender).\n"
...
func SetupCLI(args []string) error {
	...
	app := &cli.App{
		...
		Name:        "otapulse",
		Usage:       "manage and start the OTAPulse client.",
		Version:     ShowVersion(),
	}
	app.Commands = []*cli.Command{
		...
		},
		{
			...
			Usage: "Perform configuration setup - " +
				"'otapulse setup --help' for command options.",
			ArgsUsage: "[options]",
