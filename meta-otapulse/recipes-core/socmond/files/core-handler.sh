...
LOG_FILE="/var/log/socmond/coredump.log"
...
# Skip coredumps from socmond itself to prevent infinite loops
case "${EXECUTABLE}" in
    socmond*|core-handler*)
