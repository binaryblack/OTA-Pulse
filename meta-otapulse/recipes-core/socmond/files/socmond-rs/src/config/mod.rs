//! Configuration module for socmond
//!
...
fn default_metrics_socket() -> String {
    "/run/socmond/metrics.sock".to_string()
}
...
fn default_coredump_path() -> String {
    "/var/lib/socmond/coredumps".to_string()
}
...
fn default_reason_file() -> String {
    "/var/lib/socmond/last_reboot_reason".to_string()
}
