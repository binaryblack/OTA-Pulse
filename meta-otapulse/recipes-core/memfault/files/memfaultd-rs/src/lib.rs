//! memfaultd - SoC Monitoring Library
//!
//! This library provides the core functionality for the memfaultd daemon
...
pub const DEFAULT_CONFIG_PATH: &str = "/etc/memfault/config.json";

/// Default socket path
pub const DEFAULT_SOCKET_PATH: &str = "/run/memfault/metrics.sock";

/// Result type alias for memfaultd operations
